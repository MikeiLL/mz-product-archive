...
class Projects_Taxonomy {
	...
	public function __construct ( $token = 'project-category', $singular = '', $plural = '', $args = array() ) {
		...
		if ( '' == $this->singular ) $this->singular = __( 'Category', 'projects-by-mzoo' );
		if ( '' == $this->plural ) $this->plural = __( 'Categories', 'projects-by-mzoo' );
	...
	private function _get_default_labels () {
		return array(
			    'name'                => sprintf( _x( 'Project %s', 'taxonomy general name', 'projects-by-mzoo' ), $this->plural ),
			    'singular_name'       => sprintf( _x( '%s', 'taxonomy singular name', 'projects-by-mzoo' ), $this->singular ),
			    'search_items'        => sprintf( __( 'Search %s', 'projects-by-mzoo' ), $this->plural ),
			    'all_items'           => sprintf( __( 'All %s', 'projects-by-mzoo' ), $this->plural ),
			    'parent_item'         => sprintf( __( 'Parent %s', 'projects-by-mzoo' ), $this->singular ),
			    'parent_item_colon'   => sprintf( __( 'Parent %s:', 'projects-by-mzoo' ), $this->singular ),
			    'edit_item'           => sprintf( __( 'Edit %s', 'projects-by-mzoo' ), $this->singular ),
			    'update_item'         => sprintf( __( 'Update %s', 'projects-by-mzoo' ), $this->singular ),
			    'add_new_item'        => sprintf( __( 'Add New %s', 'projects-by-mzoo' ), $this->singular ),
			    'new_item_name'       => sprintf( __( 'New %s Name', 'projects-by-mzoo' ), $this->singular ),
			    'menu_name'           => sprintf( __( '%s', 'projects-by-mzoo' ), $this->plural )
			  );
