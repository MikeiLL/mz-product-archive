...
class Projects_Settings {
	...
	public function projects_add_settings_page() {
		add_submenu_page( 'edit.php?post_type=project', __( 'Settings', 'projects-by-mzoo' ), __( 'Settings', 'projects-by-mzoo' ), 'publish_posts', 'projects-settings-page', array( $this, 'projects_settings_page' ) );
	...
	public function get_settings_sections () {
		...
		$settings_sections['pages-fields'] 		= __( 'Pages', 'projects-by-mzoo' );
		$settings_sections['images-fields'] 	= __( 'Images', 'projects-by-mzoo' );
	...
	public function projects_settings_page() {
		...
		<div class="wrap">
			...
			<h2><?php _e( 'Projects Settings', 'projects-by-mzoo' ); ?></h2>
	...
	public function projects_pages_settings() {
		?>
		<p><?php _e( 'Configure projects pages.', 'projects-by-mzoo' ); ?></p>
		<?php
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e( 'Projects Page', 'projects-by-mzoo' ); ?></th>
				<td>
	...
	public function projects_images_settings() {
		?>
		<p><?php _e ( 'These settings control the dimensions of thumbnails in your projects. After updating these settings you may need to' , 'projects-by-mzoo' ); ?> <a href="http://wordpress.org/extend/plugins/regenerate-thumbnails/"><?php _e( 'regenerate your thumbnails', 'projects-by-mzoo' ); ?></a>.</p>
		<?php
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row">
					<?php _e( 'Archive Images', 'projects-by-mzoo' ); ?>
				</th>
				<td>
					<?php $crop = isset( $options['project-archive']['crop'] ) ? $options['project-archive']['crop'] : 'no'; ?>
					<?php _e( 'Width:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-archive][width]" value="<?php echo $options['project-archive']['width']; ?>" /> <?php _e( 'Height:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-archive][height]" value="<?php echo $options['project-archive']['height']; ?>" /> <?php _e( 'Crop:', 'projects-by-mzoo' ); ?> <input type="checkbox" name="projects-images-fields[project-archive][crop]" value="1" <?php checked( $crop, 'yes' );?> />
				</td>
			</tr>
			<tr valign="top">
				<th scope="row">
					<?php _e( 'Single Images', 'projects-by-mzoo' ); ?>
				</th>
				<td>
					<?php $crop = isset( $options['project-single']['crop'] ) ? $options['project-single']['crop'] : 'no'; ?>
					<?php _e( 'Width:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-single][width]" value="<?php echo $options['project-single']['width']; ?>" /> <?php _e( 'Height:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-single][height]" value="<?php echo $options['project-single']['height']; ?>" /> <?php _e( 'Crop:', 'projects-by-mzoo' ); ?> <input type="checkbox" name="projects-images-fields[project-single][crop]" value="1" <?php checked( $crop, 'yes' );?> />
				</td>
			</tr>
			<tr valign="top">
				<th scope="row">
					<?php _e( 'Thumbnails', 'projects-by-mzoo' ); ?>
				</th>
				<td>
					<?php $crop = isset( $options['project-thumbnail']['crop'] ) ? $options['project-thumbnail']['crop'] : 'no'; ?>
					<?php _e( 'Width:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-thumbnail][width]" value="<?php echo $options['project-thumbnail']['width']; ?>" /> <?php _e( 'Height:', 'projects-by-mzoo' ); ?> <input type="text" size="3" name="projects-images-fields[project-thumbnail][height]" value="<?php echo $options['project-thumbnail']['height']; ?>" /> <?php _e( 'Crop:', 'projects-by-mzoo' ); ?> <input type="checkbox" name="projects-images-fields[project-thumbnail][crop]" value="1" <?php checked( $crop, 'yes' );?> />
				</td>
			</tr>
		</table>
		<?php
