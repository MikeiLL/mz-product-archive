...
class Woothemes_Widget_Projects extends WP_Widget {
	...
	public function __construct() {
		...
		$this->projects_widget_description 	= __( 'Recent projects listed on your site.', 'projects-by-mzoo' );
		$this->projects_widget_idbase 		= 'projects';
		$this->projects_widget_title 		= __( 'Recent Projects', 'projects-by-mzoo' );
    ...
    public function form( $instance ) {
		...
		$defaults = array(
			'title' 		=> __( 'Recent Projects', 'projects-by-mzoo' ),
			'limit' 		=> 5,
		);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Limit:', 'projects-by-mzoo' ); ?></label>
