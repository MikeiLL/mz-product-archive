...
class Woothemes_Widget_Project_Categories extends WP_Widget {
	...
	public function __construct() {
		...
		$this->projects_widget_description 	= __( 'Project Categories', 'projects-by-mzoo' );
		$this->projects_widget_idbase 		= 'woothemes-project-categories';
		$this->projects_widget_title 		= __( 'Project Categories', 'projects-by-mzoo' );
    ...
    public function form( $instance ) {
		...
		$defaults = array(
			'title' 		=> __( 'Project Categories', 'projects-by-mzoo' ),
			'count'			=> 1,
			'hierarchical'	=> 1,
		);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title (optional):', 'projects-by-mzoo' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Show Count:', 'projects-by-mzoo' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'hierarchical' ); ?>"><?php _e( 'Show Hierarchy:', 'projects-by-mzoo' ); ?></label>
		</p>
<?php
	} // End form()
