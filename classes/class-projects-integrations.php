...
class Projects_Integrations {
	...
	public function testimonials_custom_fields( $fields ) {
		...
		$fields['testimonials_search'] = array(
			'name' 			=> __( 'Testimonial', 'projects-by-mzoo' ),
			'description' 	=> __( 'Search for Testimonial to link to this Project. (Optional)', 'projects-by-mzoo' ),
			'type' 			=> 'text',
			'default' 		=> '',
			'section' 		=> 'info',
		);
		...
		$fields['testimonials_id'] = array(
			'name' 			=> __( 'Testimonial ID', 'projects-by-mzoo' ),
			'description' 	=> __( 'Holds the id of the selected testimonial.', 'projects-by-mzoo' ),
			'type' 			=> 'hidden',
			'default' 		=> 0,
			'section' 		=> 'info',
		);
	...
	public function woocommerce_custom_fields( $fields ) {
		...
		$fields['products_search'] = array(
			'name' 			=> __( 'Product', 'projects-by-mzoo' ),
			'description' 	=> __( 'Search for Product to link to this Project. (Optional)', 'projects-by-mzoo' ),
			'type' 			=> 'text',
			'default' 		=> '',
			'section' 		=> 'info',
		);
		...
		$fields['products_id'] = array(
			'name' 			=> __( 'Product ID', 'projects-by-mzoo' ),
			'description' 	=> __( 'Holds the id of the selected product.', 'projects-by-mzoo' ),
			'type' 			=> 'hidden',
			'default' 		=> 0,
			'section' 		=> 'info',
		);
