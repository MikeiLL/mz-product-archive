...
class Projects {
	...
	public function post_type_names () {
		$this->singular_name 	= apply_filters( 'projects_post_type_singular_name', _x( 'Project', 'post type singular name', 'projects-by-mzoo' ) );
	...
	public function load_localisation () {
		load_plugin_textdomain( 'projects-by-mzoo', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
