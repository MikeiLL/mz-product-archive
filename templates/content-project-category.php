 ...
 *
 * Override this template by copying it to yourtheme/projects/content-product_cat.php
 *
 * @author 		WooThemes
...
$projects_loop['loop']++;
?>
<li class="product_cat project<?php
	...
	<a href="<?php echo get_term_link( $category->slug, 'project-category' ); ?>">
