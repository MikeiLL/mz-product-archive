...
if ( ! is_admin() || defined('DOING_AJAX') ) {
	 ...
	 */
	add_action( 'projects_before_single_project_description', 'projects_template_single_title', 10 );
	add_action( 'projects_before_single_project_description', 'projects_template_single_feature', 30 );
	add_action( 'projects_before_single_project_description', 'projects_template_single_gallery', 40 );
	add_action( 'projects_before_single_project_description', 'projects_template_single_short_description', 60 );
	 ...
	 */
	add_action( 'projects_single_project_description', 'projects_template_single_description', 10 );
	add_action( 'projects_single_project_description', 'projects_template_single_meta', 20 );
